...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'cowell_brand/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'cowell_brand/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'cowell_brand/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'cowell_brand/images/file';
